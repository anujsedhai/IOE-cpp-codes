/*@Question:Create a class called Musicians to contain three methods string ( ), wind ( ) and perc ( ). Each of
            ...
            called TypeIns to contain a method called get ( ) and show ( ). The get ( ) method must display
            a menu as follows
